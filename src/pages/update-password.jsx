  ...
  const handleChange = useCallback((e) => {
    ...
    if (e.target.name == "password" || e.target.name == "confirmPassword") {
      if (e.target.value.length < 8) {
        setErrors((prev) => ({
          ...prev,
          [e.target.name]: `this fields must have at least 8 characters.`,
        }));
        return;
      }
    }
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <span className="builder-text css-1qggkls">Old Password</span>
              </span>
            </label>
            <input
              id="oldpassword"
            ...
            />
            {errors.oldPassword && (
              <p className="error-msg">{errors.oldPassword}</p>
            )}
          </div>
          {/* New Password */}
          <div
          ...
          >
            ...
            >
              <span
                ...
                builder-id="builder-5458e77326004eee988b5e146b0f3650"
              >
                <span className="builder-text css-1qggkls">New Password</span>
              </span>
            </label>
            <input
              id="newPassword"
